...
/* ---- 控制模式默认值（上板实测整定后固化） ---- */
#define M2006_MOTOR_POS_PID_KP_DEFAULT (3.0f)
#define M2006_MOTOR_POS_DEADBAND_DEFAULT (0.1f)
#define M2006_MOTOR_POS_MAX_SPEED_DEFAULT (300.0f)
#define M2006_MOTOR_SPD_PID_KP_DEFAULT (200.0f)
#define M2006_MOTOR_SPD_PID_KI_DEFAULT (18000.0f)
